...
*/
#ifndef __AES_TWOFISH__
#define __AES_TWOFISH__

#include	<stdio.h>
#include	<openssl/platform_twofish.h>/* platform-specific defines */
    ...
    for (keySize=128;keySize<=256;keySize+=64)
        for (testCnt=0;testCnt<10;testCnt++)
        {
            if (TestTwofish(MODE_ECB,keySize)) { 
                ...
                /* printf("[%d] ECB test passed with keySize[%d]\n", \ */
                /*        testCnt, keySize); */
            }
            ...
            if (TestTwofish(MODE_CBC,keySize)) { 
                ...
                /* printf("[%d] CBC test passed with keySize[%d]\n", \ */
                /*        testCnt, keySize); */
            }
        }
